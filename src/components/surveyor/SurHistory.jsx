...
const SurHistory = () => {
  ...
  return (
    <>
              ...
              <div className="sur_pr">
                <div className="input-group">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end">
                    <li>
                      <a className="dropdown-item">Parliament1</a>
                    </li>
                    <li>
                      <a className="dropdown-item">Parliament2</a>
                    </li>
                    <li>
                      <a className="dropdown-item">Parliament3</a>
                    </li>
                    <li>
                      <a className="dropdown-item">Parliament4</a>
                    </li>
                  </ul>
                </div>
              </div>
      ...
      ></MobileModal>
      <div
        class="modal fade sur_edit-modal"
        id="surEditModal"
        tabindex="-1"
        aria-labelledby="surEditModalLabel"
        aria-hidden="true"
      >
            ...
            <div class="modal-body">
              <div className="sur_m-cnt">
                <div className="sur_input-box">
                  <span className="sr_ed-inp-n">Parliament</span>
